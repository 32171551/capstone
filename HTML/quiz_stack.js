function Question(text, choice, answer) {
 ...
 var questions = [
    ...
    new Question('3. 다음 중 순서대로 <김 아 우 차 커>를 FILO식으로 순서로 나타낸 것은?', ['커 차 우 아 김', '김 아 우 차 커', '아 우 차 커 김', '커 우 김 아 차  '], '커 차 우 아 김 '),
    new Question('4. 스택의 응용분야가 아닌것은?', ['작업 스케줄링', '수식의 계산', '시스템 스택', '서브루틴 호출'], '작업 스케줄링')
 ];
